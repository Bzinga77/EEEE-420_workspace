...
CheckAgain	bis #TACLR, &TA0CTL 	; Clear TAR
			...
			call #SWtimer			;
			xor #CCIS0, &TA0CCTL1	;
			mov TA0CCR1, meas_latest; Moves TACCR1 into Meas_latest
			bic #MC1+MC0, &TA0CTL 	; stop TA
			cmp	meas_base, meas_latest; compares if meas_latest = 0x30
			jge	NoKey				; if meas_latest =/= 0x30 jump to NoKey
			xor #1, P1OUT			; Toggle center LED if key "pressed"

NoKey		cmp #0x0460, meas_latest; compare if meas_latest
			jeq	LowerThreshold		;
			xor #0, P1OUT			;
			jmp CheckAgain			;
